                ...
                <div class="col-md-12">
                    <div class="box-header">
                        ...
                        <div class="input-group">
                            ...
                            <a href="<?= site_url('laporansk/reset') ?>" class="btn btn-danger" title="Reset Pencarian">Reset</a>
                        </div>
                        </form>
                        <span class="pull-right">
                            <a href="<?= site_url('laporansk/export') ?>" class="btn bg-olive btn-flat" title="Export ke Excel"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;Export Excel</a>
                        </span>
                    </div>
                    <!-- /.box-header -->
                </div>
