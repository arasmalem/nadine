...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview <?php if ($this->uri->segment(1) == 'klasifikasisurat' or $this->uri->segment(1) == 'sifatsurat' or $this->uri->segment(1) == 'unitkerja') echo 'active'; ?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?= site_url('unitkerja') ?>"><i class="fa fa-list-ul"></i> Struktur Organisasi</a></li>
                    <li><a href="<?= site_url('klasifikasisurat') ?>"><i class="fa fa-code-fork"></i> Klasifikasi Surat</a></li>
                    <li><a href="<?= site_url('sifatsurat') ?>"><i class="fa fa-info-circle"></i> Sifat Surat</a></li>
                </ul>
            </li>
            ...
            <li class="treeview <?php if ($this->uri->segment(1) == 'spt' or $this->uri->segment(1) == 'spacespt') echo 'active'; ?>">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?= site_url('spt') ?>"><i class="fa fa-circle-o text-aqua"></i> Surat Perintah Tugas</a></li>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview <?php if ($this->uri->segment(1) == 'laporankeluar' or $this->uri->segment(1) == 'laporansk' or $this->uri->segment(1) == 'laporanspt') echo 'active'; ?>">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?= site_url('laporankeluar') ?>"><i class="fa fa-send-o"></i> Surat Keluar</a></li>
                    <li><a href="<?= site_url('laporansk') ?>"><i class="fa fa-file-o"></i> SK</a></li>
                    <li><a href="<?= site_url('laporanspt') ?>"><i class="fa fa-file-text-o"></i> SPT</a></li>
                </ul>
            </li>
            <li class="<?php if ($this->uri->segment(1) == 'backupdb') echo 'active'; ?>">
                <a href="<?= site_url('backupdb') ?>">
