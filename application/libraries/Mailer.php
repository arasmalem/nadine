...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'sdebkdjatim@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'SDE BKD Jatim'; // Isikan dengan nama pengirim
    protected $password = 'buatapatanyapassword'; // Isikan dengan password email pengirim
